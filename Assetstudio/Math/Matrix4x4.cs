...
namespace AssetStudio
{
    ...
    public struct Matrix4x4 : IEquatable<Matrix4x4>
    {
        ...
        public Matrix4x4(float[] values)
        {
            ...
            if (values.Length != 16)
                throw new ArgumentOutOfRangeException(nameof(values), "Matrix必须有16个且只有16个输入值.");
        ...
        public float this[int index]
        {
            get
            {
                switch (index)
                {
                    ...
                    case 14: return M23;
                    case 15: return M33;
                    default: throw new ArgumentOutOfRangeException(nameof(index), "Matrix4x4索引无效!");
                }
            }
        ...
        public Vector4 GetRow(int index)
        {
            switch (index)
            {
                ...
                default: throw new IndexOutOfRangeException("行索引无效!");
            }
        }
