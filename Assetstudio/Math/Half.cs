    ...
    public struct Half : IComparable, IFormattable, IConvertible, IComparable<Half>, IEquatable<Half>
    {
        ...
        public int CompareTo(object obj)
        {
            ...
            else
            {
                ...
                {
                    throw new ArgumentException("对象必须是半类型.");
                }
            }
        ...
        public static int Sign(Half value)
        {
            ...
            else
            {
                if (value != 0)
                {
                    throw new ArithmeticException("函数不接受浮点Not-a-Number值.");
                }
            }
        ...
        {
            throw new InvalidCastException(string.Format(CultureInfo.CurrentCulture, "无效的强制转换'{0}' to '{1}'.", "Half", "Char"));
        }
        DateTime IConvertible.ToDateTime(IFormatProvider provider)
        {
            throw new InvalidCastException(string.Format(CultureInfo.CurrentCulture, "无效的强制转换'{0}' to '{1}'.", "Half", "DateTime"));
        }
