...
namespace AssetStudio
{
    public static class GameManager
    {
        ...
        static GameManager()
        {
            ...
            Games.Add(index++, new Game(GameType.EnsembleStar2));
            ...
            Games.Add(index++, new Game(GameType.Naruto));
            Games.Add(index++, new Game(GameType.XinYueTongXing));
            Games.Add(index++, new Game(GameType.SoulLand));
            Games.Add(index++, new Game(GameType.ReturnOfTheDragonTide));
    ...
    public static class GameTypes
    {
        ...
        public static bool IsUnityCN(this GameType type) => type == GameType.UnityCN || type == GameType.ReturnOfTheDragonTide;
        ...
        public static bool IsWuQiMiTu(this GameType type) => type == GameType.PathtoNowhere;
        public static bool IsHuoYingRenZhe(this GameType type) => type == GameType.Naruto;
        public static bool IsXinYueTongXing(this GameType type) => type == GameType.XinYueTongXing;
        public static bool IsLieHunShiJie(this GameType type) => type == GameType.SoulLand;
        public static bool IsGuiLongChao(this GameType type) => type == GameType.ReturnOfTheDragonTide;
        ...
        {
            GameType.SR or GameType.SR_CB2 => true,
            _ => false,
        };

        public static bool IsBlockFile(this GameType type) => type switch
        {
            GameType.BH3 or GameType.BH3Pre or GameType.ZZZ_CB2 or GameType.ZZZ or GameType.SR or GameType.GI_Pack or GameType.TOT or GameType.WangYue or GameType.ArknightsEndfield or GameType.ReturnOfTheDragonTide => true,
            _ => false,
        };
