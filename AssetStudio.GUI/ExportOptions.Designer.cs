...
namespace AssetStudio.GUI
{
    partial class ExportOptions
    {
        ...
        private void InitializeComponent()
        {
            ...
            texTypeComboBox.Items.AddRange(new object[] { "漫反射", "法线贴图", "镜面反射", "凹凸", "环境光", "自发光", "反射", "置换" });
            ...
            uvTypesComboBox.Items.AddRange(new object[] { "漫反射", "法线贴图", "镜面反射", "凹凸", "环境光", "自发光", "反射", "置换" });
            ...
            assetGroupOptions.Items.AddRange(new object[] { "类型名称", "容器路径", "源文件名称", "不分组" });
            ...
            convertAudio.Text = "转换AudioClip为WAV(PCM)";
